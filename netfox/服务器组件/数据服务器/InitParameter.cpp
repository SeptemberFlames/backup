...
VOID CInitParameter::LoadInitParameter()
{
	...
	//读取配置
	m_cbDelayList=IniData.ReadInt(TEXT("LogonConServer"),TEXT("DelayList"),m_cbDelayList);
	m_wMaxConnect=IniData.ReadInt(TEXT("LogonConServer"),TEXT("ConnectMax"),m_wMaxConnect);
	m_wServicePort=IniData.ReadInt(TEXT("LogonConServer"),TEXT("ServicePort"),m_wServicePort);
