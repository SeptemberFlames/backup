...
//调度管理类
class CAttemperEngine : public IAttemperEngine, public IAsynchronismEngineSink, public IDataBaseEngineEvent,
	public ITimerEngineEvent, public ITCPSocketEvent, public ITCPNetworkEngineEvent
{
	//组件变量
protected:
...
protected:
	...
	CCriticalSection				m_AttemperEngineSection;			//锁定对象 
...
public:
	...
	//关闭事件
	virtual bool OnEventTCPNetworkShut(DWORD dwSocketID, DWORD dwClientAddr, DWORD dwActiveTime, BOOL bClientQuit);
	//读取事件
