...
public:
	...
	LONG GetReturnValue();
	//存储过程
	LONG ExecuteProcess(LPCTSTR pszSPName, BOOL bRecordset, DWORD dwTimeout = 0);
	//执行语句
	LONG ExecuteSentence(LPCTSTR pszCommand, BOOL  bRecordset, DWORD dwTimeout = 0);

public:
	unsigned long long get_systen_milliseconds();
};
